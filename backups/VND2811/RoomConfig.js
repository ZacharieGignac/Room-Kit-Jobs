...
export var config = {
  ...
  room: {
    name: 'VND2811',                        //Nom du système, doit être unique
    ...
    controlSystemSerial: 'creton',     //numéro de série du processeur crestron
    controlSystemSyncReboot:true,
    controlSystemRebootCommand:'HW_RESET',
